...
input:
 val genome from g209_15_genomePath_g209_13
...
input:
 val gtf from g209_15_gtfPath_g209_4
...
input:
 val genome from g209_15_genomePath_g209_5
...
input:
 val genome from g209_15_genomePath_g209_10
 val gtf from g209_15_gtfPath_g209_10

output:
 val cmdAr  into g209_10_command_g209_11
 val resultDirAr  into g209_10_path_g209_11
...
input:
 val resultDir from g209_10_path_g209_11.flatten()
 val command from g209_10_command_g209_11.flatten()

output:
 val resultDir  into g209_11_genomeIndexPath_g215_19
...
input:
 val genome from g209_15_genomePath_g209_8
 val gtf from g209_15_gtfPath_g209_8

output:
 val resultDir  into g209_8_genomeIndexPath_g216_11
...
input:
 val genome from g209_15_genomePath_g209_6
...
input:
 val genome from g209_15_genomePath_g209_0
...
g_205_reads_g213_18.into{g213_18_reads_g213_19}
...
input:
 set val(name), file(reads) from g_205_reads_g213_18
...
g213_19_reads_g213_20.into{g213_20_reads_g214_32}
...
g213_20_reads_g214_32.into{g214_32_reads_g_127; g214_32_reads_g215_19}
g214_32_bowfiles_g214_26 = Channel.empty()
g214_32_bowfiles_g_177 = Channel.empty()
g214_32_bam_file_g214_23 = Channel.empty()
g214_32_bam_file_g214_27 = Channel.empty()
g214_32_bam_index_g214_23 = Channel.empty()
g214_32_bam_index_g214_27 = Channel.empty()
g214_32_filter_g214_26 = Channel.empty()
g214_32_log_file_g214_30 = Channel.empty()
} else {
...
input:
 val mate from g_204_mate_g215_19
 set val(name), file(reads) from g214_32_reads_g215_19
...
input:
 file rsemDir from g215_19_rsemOut_g215_17.collect()

output:
 file "rsem_alignment_sum.tsv"  into g215_17_outputFileTSV_g_198
...
input:
 set val(name), file(bam) from g215_19_bam_file_g219_124
...
input:
 val mate from g_204_mate_g219_123
 set val(name), file(bam) from g215_19_bam_file_g219_123
...
g214_32_reads_g_127.into{g_127_reads_g216_11; g_127_reads_g217_16; g_127_reads_g218_11}
} else {
...
input:
 val mate from g_204_mate_g218_11
 set val(name), file(reads) from g_127_reads_g218_11
 val tophat2_index from g209_6_genomeIndexPath_g218_11
...
input:
 ...
 val paired from g_204_mate_g222_126
...
input:
 ...
 val mate from g_204_mate_g222_95
...
input:
 ...
 val mate from g_204_mate_g222_82
...
input:
 val mate from g_204_mate_g217_16
 set val(name), file(reads) from g_127_reads_g217_16
 val star_index from g209_0_genomeIndexPath_g217_16
...
input:
 ...
 val paired from g_204_mate_g221_126
...
input:
 val mate from g_204_mate_g221_123
...
input:
 ...
 val mate from g_204_mate_g221_95
...
input:
 ...
 val mate from g_204_mate_g221_82
...
input:
 val mate from g_204_mate_g216_11
 set val(name), file(reads) from g_127_reads_g216_11
 val hisat2index from g209_8_genomeIndexPath_g216_11
...
input:
 ...
 val paired from g_204_mate_g220_126
...
input:
 val mate from g_204_mate_g220_123
...
input:
 ...
 val mate from g_204_mate_g220_95
...
input:
 ...
 val mate from g_204_mate_g220_82
...
input:
 file bam from g214_32_bam_file_g214_27.collect()
 file index from g214_32_bam_index_g214_27.collect()

output:
 file "*.counts.tsv"  into g214_27_outputFileTSV
...
input:
 file bam from g214_32_bam_file_g214_23.collect()
 file index from g214_32_bam_index_g214_23.collect()

output:
 file "*.counts.tsv"  into g214_23_outputFileTSV
...
input:
 file flagstat from g214_32_log_file_g214_30.collect()
 val mate from g_204_mate_g214_30

output:
 file "deduplication_summary.tsv"  into g214_30_outputFileTSV
...
input:
 ...
 val mate from g_204_mate_g213_16
...
input:
 ...
 val mate from g_204_mate_g213_11
...
input:
 set val(name), file(bowfile) from g214_32_bowfiles_g214_26
 val mate from g_204_mate_g214_26
 val filtersList from g214_32_filter_g214_26

output:
 file '*.tsv'  into g214_26_outputFileTSV_g214_13
 val "sequential_mapping_sum"  into g214_26_name_g214_13
...
input:
 file tsv from g214_26_outputFileTSV_g214_13.collect()
 val outputFileName from g214_26_name_g214_13.collect()

output:
 file "${name}.tsv"  into g214_13_outputFileTSV_g214_14
...
input:
 file rsemOut from g215_19_rsemOut_g215_15.collect()

output:
 file "*.tsv"  into g215_15_outputFile
 val wdir  into g215_15_wdir_g215_14
...
input:
 val wdir from g215_15_wdir_g215_14

output:
 file "*.rmd"  into g215_14_rMarkdown
...
input:
 ...
 val mate from g_204_mate_g218_3
...
input:
 set val(name), file(bam) from g215_19_bam_file_g219_121
...
input:
 ...
 val mate from g_204_mate_g219_82
...
input:
 set val(name), file(bam) from g215_19_bam_file_g219_122
...
input:
 ...
 val mate from g_204_mate_g219_95
...
input:
 set val(name), file(bam) from g215_19_bam_file_g219_126
 val paired from g_204_mate_g219_126
